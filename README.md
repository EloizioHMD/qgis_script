...
* 🔗 [Empacotador de Entrega Externa]([./caminho_do_script_02.py](https://github.com/EloizioHMD/qgis_script/blob/main/empacotador_entrega_externa/empacotador_entrega_externa_v1_0_0.py)): Script PyQGIS para criar pacotes vetoriais portáteis, versionados, documentados e auditáveis a partir das camadas selecionadas em um projeto QGIS.
